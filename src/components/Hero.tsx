          ...
          <div className="space-y-6 xs:space-y-8 sm:space-y-10 animate-fade-in text-center lg:text-left">
            <div className="space-y-4 xs:space-y-6 sm:space-y-8">
              ...
              <div className="space-y-3 xs:space-y-4">
                ...
                <p className="text-foreground-secondary text-sm xs:text-base sm:text-lg md:text-xl leading-relaxed max-w-2xl mx-auto lg:mx-0">
                  B.Tech Information Technology student at{" "}
                  <span className="text-brand-primary font-semibold">NIT Srinagar</span>{" "}
                  <span className="hidden xs:inline">With hands-on expertise in building scalable, user-focused applications, and a strong passion for developing innovative digital solutions that create real-world impact.</span>
                  <span className="xs:hidden">Passionate about building innovative digital solutions with real-world impact.</span>
                </p>
              </div>
            </div>
            ...
            <div className="flex flex-col xs:flex-row gap-3 xs:gap-4 sm:gap-6 items-center justify-center lg:justify-start">
              ...
              <Button 
                variant="outline" 
                className="group glass-card border-2 border-foreground-secondary/20 hover:border-brand-primary/50 px-4 xs:px-6 sm:px-8 py-3 xs:py-3.5 sm:py-4 rounded-xl xs:rounded-2xl font-semibold text-sm xs:text-base sm:text-lg hover:bg-brand-primary/5 transition-all duration-300 hover:scale-105 w-full xs:w-auto"
            ...
            <div className="flex gap-2 xs:gap-3 sm:gap-4 pt-4 xs:pt-6 justify-center lg:justify-start">
              <Button
                variant="ghost"
                size="icon"
                className="w-10 h-10 xs:w-12 xs:h-12 sm:w-14 sm:h-14 glass-card hover:glass-card-hover rounded-lg xs:rounded-xl sm:rounded-2xl group transition-all duration-300 hover:scale-110"
                onClick={() => window.open('https://github.com/kritikadevi', '_blank')}
              >
                <Github className="w-4 h-4 xs:w-5 xs:h-5 sm:w-6 sm:h-6 group-hover:text-brand-primary transition-colors" />
              </Button>
              <Button
                variant="ghost"
                size="icon"
              ...
              >
                <Linkedin className="w-4 h-4 xs:w-5 xs:h-5 sm:w-6 sm:h-6 group-hover:text-brand-secondary transition-colors" />
              </Button>
              <Button
                variant="ghost"
                size="icon"
              ...
              >
                <Mail className="w-4 h-4 xs:w-5 xs:h-5 sm:w-6 sm:h-6 group-hover:text-brand-accent transition-colors" />
              </Button>
            </div>
          </div>
